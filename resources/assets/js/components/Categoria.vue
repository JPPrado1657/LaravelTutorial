                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keypress="listarCategoria(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                        ...
                        <nav>
                            <ul class="pagination">
                                <li class="page-item">
                                    <a class="page-link" href="#" v-if="pagination.current_page > 1" @click="cambiarPagina(pagination.current_page - 1,buscar,criterio)">Ant</a>
                                </li>
                                <li class="page-item" v-for="page in pagesNumber" :key="page" :class="[page == isActived ? 'active':'']">
                                    <a class="page-link" href="#" @click.prevent="cambiarPagina(page,buscar,criterio)" v-text="page"></a>
                                </li>
                                <li class="page-item">
                                    <a class="page-link" href="#" v-if="pagination.current_page < pagination.last_page" @click="cambiarPagina(pagination.current_page + 1,buscar,criterio)">Sig</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
    ...
    export default {
        ...
        methods : {
            ...
            validarCategoria(){
                ...
                if(!this.nombre || (/^\s+$/.test(this.nombre))){
                    this.errorMostrarMsjCategoria.push("Ingrese el nombre de la categoría");
                } 
            ...
            desactivarCategoria(id){
                ...
                if (result.value) {
                    ...
                    axios.put('/categoria/desactivar',{'id':id }).then(function (response) {
                        swalWithBootstrapButtons(
                        '¡Desactivado!',
                        'Tu archivo ha sido desactivado con éxito.',
                        'success'
                        )
                        me.listarCategoria(1,'','nombre');
                    }).catch(function (error) {
           ...
           activarCategoria(id){
                ...
                if (result.value) {
                    ...
                    axios.put('/categoria/activar',{'id':id }).then(function (response) {
                        swalWithBootstrapButtons(
                        '¡Activado!',
                        'Tu archivo ha sido activado con éxito.',
                        'success'
                        )
                        me.listarCategoria(1,'','nombre');
                    }).catch(function (error) {
