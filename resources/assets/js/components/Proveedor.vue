                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keypress="listarPersona(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
        ...
        methods : {
            ...
            validarPersona(){
                ...
                if(!this.nombre || (/^\s+$/.test(this.nombre))){
                    this.errorMostrarMsjCategoria.push("Ingrese el nombre de la persona");
                } 
